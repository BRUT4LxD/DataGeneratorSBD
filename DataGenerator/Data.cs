...
namespace DataGenerator
{
    internal static class Data
    {
        ...
        public static readonly List<string> Languages = new List<string> { "German", "English", "French", "Russian", "Spanish" };
        ...
        public static readonly List<string> SkillLevel = new List<string> { "Beginner", "Intermediate", "Advanced" };
        public static readonly List<string> University = new List<string> { "PW", "WAT", "WUM", "PJATK", "UW", "SGGW", "SGH" };
        public static readonly List<string> Hobbies = new List<string> { "Chess", "Muai-Thai", "Flowers", "Mathematics", "AI", "Physics", "", "Reading", "Soccer", "Rugby", "Running", "Squash", "VolleyBall", "BasketBall" };
        ...
        public static readonly List<string> Specializations = new List<string> { "Informatics", "Psychics", "Geography", "Biology", "Dentist", "Databases", "Data Science", "Machine Learning", "Big Data", "NLP" };
